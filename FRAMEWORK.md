...
v2 · 2026-09-18 · exported from the Claude doc "Website Build Framework v2"
...
| Showpiece motion with a produced asset (3D model, render sequence, product shoot) | Asset production starts right after phase 1 with a named owner and date; phase 3b waits for it; the static fallback is designed as a real frame, not a blank | Phases 0, 1, 3b, 6 |
