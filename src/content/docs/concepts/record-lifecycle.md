...
<!--
  Phase 7 places docs/diagrams/record-lifecycle.png and its dark pair here, with
  the README's alt text verbatim (docs/CONTENT.md). The prose below is written to
  stand without it, because the diagram has to survive being a still frame and the
  page has to survive the diagram not loading.
-->
